...
desc = "A call to `.insert()` with an index too large raieses an `IndexError`."
def test():
    dll = List()
    dll.insert(0, 80)
    dll.insert(1, 81)
...
desc = "A call to `.insert()` with an index too small (beyond a valid negative index) raieses an `IndexError`."
def test():
    dll = List()
    dll.insert(0, 80)
    dll.insert(1, 81)
